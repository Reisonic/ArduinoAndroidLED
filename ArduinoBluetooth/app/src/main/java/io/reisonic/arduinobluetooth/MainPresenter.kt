...
class MainPresenter(): MainInterface {
    ...
    private val mac_address:String = "00:19:07:00:21:B7" // Mac-address bluetooth device
    ...
    override fun connectBluetoothDevice(activity: AppCompatActivity) {
    ...
    override fun connect(activity: AppCompatActivity) {
        ...
        GlobalScope.launch {
            ...
            while (status_connection == false){
                ...
                connectBluetoothDevice(activity)
